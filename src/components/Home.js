  ...
  return (
    ...
    <br/>
      <h4 className="text-center font-weight-normal">Welcome!</h4><br/>
       <h5 className="text-center font-weight-normal">Indecisive helps you and your friends uncover new adventures based on your interests!
       Invite your friends, initiate an adventure and we will take care of the rest! Based on a poll that everyone fills out about location
      ...
      <div class="card border-light align-items-center">
  		<h5 class="card-header ">Setting up your profile</h5>
 		 <div class="card-body">
	           <p class="card-text">
		          <br/>
	   ...
	   <div class=" col-16 card border-light mb-3 align-items-center">
  		<h5 class="card-header">Creating a pod with your friends</h5>
 		 <div class="card-body">
	           <p class="card-text">
		          <br/>
	  ...
	  <div class="card border-light mb-3 align-items-center">
  		<h5 class="card-header">Initiating an adventure for your pod</h5>
 		 <div class="card-body">
	           <p class="card-text">
		          <br/>
	   ...
	   <div class="card border-light mb-3 align-items-center">
  		<h5 class="card-header">Selecting final activity</h5>
 		 <div class="card-body">
